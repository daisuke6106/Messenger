...
public class MessengerMessege extends AbstractMessage{
	...
	public static final MessengerMessege ERROR_SMTP_HOSTNAME_IS_NOT_SET = new MessengerMessege("E001");
	...
	public static final MessengerMessege ERROR_SMTP_AUTH_IS_NOT_SET = new MessengerMessege("E003");
	
	/** SMTP接続時のSTARTTLSが設定されていません。 */
	public static final MessengerMessege ERROR_SMTP_STARTTLS_IS_NOT_SET = new MessengerMessege("E004");
	
	/** SMTP接続時のデバック有無が設定されていません。 */
	public static final MessengerMessege ERROR_SMTP_DEBUG_IS_NOT_SET = new MessengerMessege("E005");
	
	/** SMTP認証ユーザが指定されていません。 */
	public static final MessengerMessege ERROR_SMTP_USER_IS_NOT_SET = new MessengerMessege("E006");
	
	/** SMTP認証パスワードが指定されていません。 */
	public static final MessengerMessege ERROR_SMTP_PASSWORD_IS_NOT_SET = new MessengerMessege("E007");

	/** メール送信先アドレスの指定が不正です。 */
	public static final MessengerMessege ERROR_SEND_MAILADDRESS_IS_FAILE = new MessengerMessege("E008");
