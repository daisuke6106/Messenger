...
public class MessengerFatalExceptionTest extends MessengerFoundationTest {
	
	@Test
	public void test() {
		// メッセージオブジェクトのみ指定して実行した場合
		// 埋め込み文字列、throwクラスは取得できないこと
		MessengerFatalException sut1 = new MessengerFatalException(M0001);
		...
		// 指定の埋め込み文字列が取得できること
		// throwクラスは取得できないこと
		MessengerFatalException sut2 = new MessengerFatalException(M0001, "http://www.google.com");
		...
		// 埋め込み文字列が取得できないこと
		// throwクラスは取得できること
		MessengerFatalException sut3 = new MessengerFatalException(M0001, new NullPointerException());
		...
		// 指定の埋め込み文字列が取得できること
		// throwクラスが取得できること
		MessengerFatalException sut4 = new MessengerFatalException(M0001, "http://www.google.com", new NullPointerException());
		...
		MessengerFatalException sut5 = new MessengerFatalException(M0001, strList, new NullPointerException());
		...
		MessengerFatalException sut6 = new MessengerFatalException(M0001, strArray, new NullPointerException());
